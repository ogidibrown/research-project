    ...
    <div className='flex flex-col gap-4'>
        ...
        <div className=' grid md:grid-cols-4 items-center gap-3 p-2'>
             <div className='flex flex-col items-center justify-center  text-center md:mb-3  p-2 gap-3'>
                <Image src={Lorna} width={160} height={120} alt='Lorna' className='rounded-[100%] bg-[#bbb]' />
            ...
            <div className='flex flex-col items-center justify-center  text-center md:mt-4  p-2 gap-3'>
                <Image src={Fred} width={150} height={120} alt='Lorna' className='rounded-[100%] bg-[#bbb]' />
            ...
            <div className='flex flex-col items-center justify-center  text-center   p-2 gap-3'>
                <Image src={Marian} width={150} height={120} alt='Lorna' className='rounded-[100%] bg-[#bbb]' />
            ...
            <div className='flex flex-col items-center justify-center text-center md:mt-[30px]  gap-3  p-2'>
                <Image src={Frederik} width={150} height={120} alt='Lorna' className='rounded-[100%]  bg-[#bbb]' />
            ...
            <div className='flex flex-col items-center justify-center md:mb-[50px] text-center gap-3  p-2'>
                <Image src={Katie} width={150} height={120} alt='Lorna' className='rounded-[100%] md:mt-[20px] bg-[#bbb]' />
            ...
            <div className='flex flex-col items-center justify-center text-center  gap-3 p-2'>
                <Image src={Eric} width={150} height={120} alt='Lorna' className='rounded-[100%] bg-[#bbb]' />
            ...
            <div className='flex flex-col items-center justify-center text-center   gap-3 p-2'>
                <Image src={Shadrack} width={150} height={120} alt='Lorna' className='rounded-[100%] bg-[#bbb]' />
            ...
            <div className='flex flex-col items-center justify-center  text-center   p-2 gap-3'>
                <Image src={Derrick} width={150} height={120} alt='Lorna' className='rounded-[100%] bg-[#bbb]' />
